...
"""
Welcome to the **AI Web Scraper** - 
"""
"""
A powerful, AI-driven tool designed to simplify and automate your web data extraction. Easily scrape data from multiple URLs, specify custom fields, handle pagination, and transform raw content into structured formats like JSON or Markdown. With features like manual attended mode and cost tracking, this tool is perfect for researchers, developers, and analysts seeking efficiency and precision in data collection. Unlock seamless web scraping and take control of your data today!
"""
...
if num_urls <= 1:
    ...
    # If multiple URLs entered; disable Pagination and Attended Mode
...
if st.session_state['scraping_state'] == 'waiting':
    # Attended mode: setting up driver and will wait for user interaction
    ...
    with st.spinner('Scraping in progress...'):
        ...
        if st.session_state['attended_mode'] and driver is not None:
            ...
            if st.session_state['use_pagination']:
                ...
                # Checking if pagination_data is a dict or a model with 'page_urls' attribute
            ...
            for i, url in enumerate(st.session_state['urls'], start=1):
                ...
                # Will scrape data if fields are specified
                if show_tags:
                    # Create dynamic models
                    DynamicListingModel = create_dynamic_listing_model(st.session_state['fields'])
                    DynamicListingsContainer = create_listings_container_model(DynamicListingModel)
        ...
        for i, data in enumerate(all_data, start=1):
            ...
            if isinstance(data, dict):
                if 'listings' in data and isinstance(data['listings'], list):
                    ...
                    # If 'listings' is not in the dict or not a list, will use the entire dict
